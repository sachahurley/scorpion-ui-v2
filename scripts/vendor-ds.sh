...
#   5. src/data/harness-index.json                       (Harness page facts,
#      generated by scripts/gen-harness-index.mjs from the lint rules, CI
#      workflows, decision records, insights and baseline counts, so the page
#      cannot quote a number the repo no longer has)
#   6. vendor/scorp-ds/VERSION                           (source commit)
#
...
# --- stage the Harness page facts (generated from the harness itself) ------
node "$REPO_ROOT/scripts/gen-harness-index.mjs" "$SCORP_DS_DIR" "$REF" "$STAGE/harness-index.json"
...
compare_or_copy "$STAGE/harness-index.json" "$REPO_ROOT/src/data/harness-index.json"
