    ...
    <div className="container mx-auto px-5 lg:px-10 pt-5 lg:pt-10 pb-5 lg:pb-20">
      ...
      */}
      <div className="flex flex-col gap-2 mb-10">
        <h2 className="text-2xl font-mono text-[var(--text-primary)]">Inputs</h2>
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.sepia.300</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-400 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.sepia.400</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
              ...
              {/* Text Colors */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
              ...
              {/* Placeholder Colors */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Placeholder Text</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-400 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Light: color.sepia.400</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Dark: color.sepia.600</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Background (Light): color.error.50</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-none">
            <div className="flex gap-3">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm font-mono text-secondary-800 dark:text-secondary-500">
                  <li>• Always use <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">label</code> elements with inputs for screen readers</li>
                  <li>• Connect labels to inputs using matching <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">id</code> and <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">htmlFor</code> attributes</li>
                  <li>• Include visible focus states (2px ring) for keyboard navigation</li>
                  <li>• Use appropriate <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">type</code> attributes (email, password, tel, etc.) for better mobile keyboards</li>
                  <li>• Provide clear error messages with <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">aria-describedby</code> for screen readers</li>
                  <li>• Mark required fields with <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">required</code> attribute or visible asterisk</li>
                </ul>
              </div>
            </div>
          </div>
