  ...
  return (
    <div className="container mx-auto px-5 lg:px-10 pt-5 lg:pt-10 pb-5 lg:pb-20">
        <div className="max-w-4xl">
          <h1 className="text-4xl mb-4">Component Library</h1>
          <p className="text-xl text-[var(--text-secondary)] mb-12">
            Reusable React components built entirely from design tokens. Copy, customize, and use in your projects.
          </p>

          {/* Coming Soon Notice */}
          <div className="p-8 border-2 border-primary-300 dark:border-primary-700 bg-primary-50 dark:bg-primary-950/20">
            <h2 className="text-2xl mb-3">Components Coming Soon!</h2>
          ...
          <section className="mt-12">
            <h2 className="text-2xl mb-6">Preview: Theme Toggle Component</h2>
            <div className="p-8 border border-[var(--surface-container-stroke)] bg-[var(--surface-container)]">
              ...
              <div className="mt-6 p-4 bg-secondary-100 dark:bg-secondary-900">
                <p className="mb-2">Usage:</p>
                <code className="block bg-secondary-900 text-[var(--accent)] p-4 text-sm font-mono overflow-x-auto">
{`import { ThemeToggle } from "@/components/ui/ThemeToggle";
