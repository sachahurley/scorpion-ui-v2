    ...
    <div className="container mx-auto px-5 lg:px-10 pt-5 lg:pt-10 pb-5 lg:pb-20">
      ...
      */}
      <div className="flex flex-col gap-2 mb-10">
        <h2 className="text-2xl font-mono text-[var(--text-primary)]">Buttons</h2>
      ...
      */}
      ...
      <section className="mb-10">
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="mb-8">
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">All Variants (Medium Size)</h4>
            <div className="flex flex-wrap gap-4">
          ...
          <div className="mb-8">
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">All Sizes (Primary Variant)</h4>
            <div className="flex flex-wrap items-end gap-4">
              <div className="flex flex-col gap-2">
                <Button variant="primary" size="large" iconLeft={<TuiIcon name="Plus" />}>Add Item</Button>
                <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600">Large (24px icon)</p>
              </div>
              <div className="flex flex-col gap-2">
                <Button variant="primary" size="medium" iconLeft={<TuiIcon name="Plus" />}>Add Item</Button>
                <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600">Medium (20px icon)</p>
              </div>
              <div className="flex flex-col gap-2">
                <Button variant="primary" size="small" iconLeft={<TuiIcon name="Plus" />}>Add Item</Button>
                <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600">Small (16px icon)</p>
              </div>
            </div>
          </div>
          ...
          {/* Common Use Cases */}
          <div>
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">Common Use Cases</h4>
            <div className="flex flex-wrap gap-4">
      ...
      <section className="mb-10">
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="mb-8">
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">Small Size (32×32px, 16px icon)</h4>
          ...
          <div className="mb-8">
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">Medium Size (40×40px, 20px icon)</h4>
            <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="mb-8">
            <h4 className="text-sm font-mono text-[var(--text-primary)] mb-4">Large Size (48×48px, 24px icon)</h4>
            <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="p-6 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-none">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-secondary-800 dark:text-secondary-500">
                  Icon-only buttons must include an <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">aria-label</code> attribute 
                  to describe the button's action for screen reader users. Example: <code className="px-2 py-0.5 bg-secondary-200 dark:bg-secondary-800">aria-label="Search"</code>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Background (Light) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Background (Light)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.primary.400 (amber.400)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-500 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.primary.500 (amber.500)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.primary.600 (amber.600)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Background (Dark) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Background (Dark)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-400 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.primary.400 (amber.400)</span>
              ...
              {/* Text (Light & Dark) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text (Light & Dark)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-black border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">color.black</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                      <span className="text-sm font-mono text-[var(--text-primary)]">Padding Y: 6px</span>
                    </div>
                  </div>
                </div>
                {/* Medium */}
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                      <span className="text-sm font-mono text-[var(--text-primary)]">Padding Y: 10px</span>
                    </div>
                  </div>
                </div>
                {/* Large */}
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                      <span className="text-sm font-mono text-[var(--text-primary)]">Padding X: 24px</span>
                    </div>
                    <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                      <span className="text-sm font-mono text-[var(--text-primary)]">Padding Y: 14px</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.secondary.700 (sepia.700)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.600 (sepia.600)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-500 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.secondary.500 (sepia.500)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-50 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">color.secondary.50 (sepia.50)</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: transparent</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-200 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.200 (sepia.200)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-300 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.secondary.300 (sepia.300)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-700 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.700 (sepia.700)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.secondary.600 (sepia.600)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Text Colors */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text (Light)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-900 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">color.secondary.900 (sepia.900)</span>
                  </div>
                </div>
              </div>

              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text (Dark)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-50 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">color.secondary.50 (sepia.50)</span>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">Always transparent</span>
                  </div>
                </div>
              </div>
              ...
              {/* Text Decoration */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text Decoration</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">Underline on hover</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.primary.600 (amber.600)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-700 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.primary.700 (amber.700)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-amber-300 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.primary.300 (amber.300)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-50 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.50 (sepia.50)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-100 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.secondary.100 (sepia.100)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-900 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.900 (sepia.900)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-800 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.secondary.800 (sepia.800)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Border (Light) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Border (Light)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-300 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.secondary.300 (sepia.300)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-400 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.secondary.400 (sepia.400)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Border (Dark) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Border (Dark)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-700 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.sepia.700</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-sepia-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.sepia.600</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.error.600 (red.600)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-700 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.error.700 (red.700)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-800 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.error.800 (red.800)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">Default: color.error.500 (red.500)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Hover: color.error.600 (red.600)</span>
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-700 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Active: color.error.700 (red.700)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Text (Both Themes) */}
              <div className="mb-3">
                <p className="text-sm font-mono text-[var(--text-primary)] mb-2">Text (Both Themes)</p>
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-white border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">color.white</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-600 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Ring Color: color.error.600 (red.600)</span>
                  </div>
                  <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">Ring Width: 2px</span>
                  </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <div className="w-4 h-4 rounded-none bg-red-500 border border-secondary-300 dark:border-secondary-600"></div>
                    <span className="text-sm font-mono text-[var(--text-primary)]">Ring Color: color.error.500 (red.500)</span>
                  </div>
                  <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">Ring Width: 2px</span>
                  </div>
      ...
      <section className="mb-10">
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            {/* Global Properties */}
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Focus Ring Properties (All Buttons)</h4>
              <div className="flex flex-wrap gap-2">
                <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
            ...
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Primary Button Focus Color</h4>
              <div className="flex flex-wrap gap-2">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                  <div className="w-4 h-4 rounded-none bg-primary-400 border border-secondary-300 dark:border-secondary-600"></div>
                  <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.primary → color.primary.400 (both themes)</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Secondary/Ghost/Outline Button Focus Color</h4>
              <div className="flex flex-wrap gap-2">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                  <div className="w-4 h-4 rounded-none bg-secondary-700 border border-secondary-300 dark:border-secondary-600"></div>
                  <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.secondary → color.secondary.700 (both themes)</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Destructive Button Focus Color</h4>
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.error → color.error.600</span>
                  </div>
                </div>
              </div>
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.error → color.error.500</span>
                  </div>
                </div>
              </div>
            </div>
