  ...
  return (
    <div className="container mx-auto px-5 lg:px-10 pt-5 lg:pt-10 pb-5 lg:pb-20">
      ...
      <div className="flex flex-col gap-2 mb-10">
        <h2 className="text-2xl font-mono text-[var(--text-primary)]">Spacing</h2>
              ...
              <div key={spacing.name} className="flex items-center gap-4">
                ...
                <div className="flex gap-2 min-w-[280px]">
                  <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">{spacing.name}</span>
                  </div>
                  <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    <span className="text-sm font-mono text-[var(--text-primary)]">{spacing.value}</span>
                  </div>
                </div>
          ...
          <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
            <div className="space-y-3">
              ...
              <div className="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3">
                <div className="text-xs font-mono text-secondary-700 dark:text-secondary-600">spacing.1 = 4px × 1</div>
                <div className="text-xs font-mono text-secondary-700 dark:text-secondary-600">spacing.2 = 4px × 2</div>
                <div className="text-xs font-mono text-secondary-700 dark:text-secondary-600">spacing.3 = 4px × 3</div>
                <div className="text-xs font-mono text-secondary-700 dark:text-secondary-600">spacing.4 = 4px × 4</div>
                <div className="text-xs font-mono text-secondary-700 dark:text-secondary-600">spacing.6 = 4px × 6</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
              ...
              <ul className="space-y-2">
                ...
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• spacing.1 (4px): Tight gaps between inline elements</li>
            ...
            <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
              ...
              <ul className="space-y-2">
                ...
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• spacing.5 (20px): Card internal spacing</li>
            ...
            <div>
              ...
              <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
                <div className="space-y-6">
                  {/* gap-2 example */}
                  <div>
                    <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mb-2">gap-2 (spacing.2 = 8px)</p>
                  ...
                  {/* gap-4 example */}
                  <div>
                    <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mb-2">gap-4 (spacing.4 = 16px)</p>
                  ...
                  {/* gap-6 example */}
                  <div>
                    <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mb-2">gap-6 (spacing.6 = 24px)</p>
          ...
          <div className="space-y-4">
            <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
              ...
              <div className="space-y-2">
                <p className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Padding: <code className="px-2 py-1 bg-secondary-100 dark:bg-secondary-900">p-4</code> (spacing.4 = 16px all sides)</p>
                <p className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Margin: <code className="px-2 py-1 bg-secondary-100 dark:bg-secondary-900">m-6</code> (spacing.6 = 24px all sides)</p>
            ...
            <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
              ...
              <ul className="space-y-2">
                ...
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Use smaller values (1-3) for tight, compact layouts</li>
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Use medium values (4-8) for standard component spacing</li>
