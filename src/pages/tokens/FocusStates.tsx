      ...
      <section className="mb-10">
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
                <div className="inline-block">
                  ...
                  <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mt-2">2px focus ring shown</p>
                </div>
              </div>
            </div>
            ...
            {/* Ring Offset */}
            <div>
              <p className="text-sm font-mono text-[var(--text-primary)] mb-3">Ring Offset</p>
              <div className="flex flex-wrap gap-2 mb-4">
                <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                  <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.offset</span>
                </div>
                <div className="inline-flex items-center px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                  <span className="text-sm font-mono text-[var(--text-primary)]">2px</span>
                </div>
              ...
              <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
                ...
                <div className="inline-block">
                  ...
                  <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mt-2">2px offset between element and ring</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mb-10">
        <div className="bg-[var(--surface-card)] border border-[var(--border-hairline)] rounded-none p-4 lg:p-8">
          ...
          <div className="space-y-6">
            {/* Primary Focus */}
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Primary Focus Ring</h4>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.primary → color.primary.400</span>
                  </div>
                </div>
              </div>
              ...
              {/* Interactive Example */}
              <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
                <p className="text-xs font-mono text-secondary-700 dark:text-secondary-600 mb-3">Try clicking then pressing Tab to see the focus ring:</p>
            ...
            {/* Secondary Focus */}
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Secondary Focus Ring</h4>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.ring.secondary → color.secondary.700</span>
                  </div>
                </div>
              </div>
            ...
            {/* Error Focus */}
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Error Focus Ring</h4>
            ...
            {/* Focus Offset Color */}
            <div>
              <h4 className="text-sm font-mono text-[var(--text-primary)] mb-3">Focus Ring Offset Color</h4>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.offset → color.sepia.50</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary-100 dark:bg-secondary-900 rounded-none border border-secondary-300 dark:border-secondary-700">
                    ...
                    <span className="text-sm font-mono text-[var(--text-primary)]">focus.offset → color.sepia.1000</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-6 border border-[var(--border-hairline)] rounded-none bg-white dark:bg-secondary-950">
              ...
              <ul className="space-y-2">
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Never remove focus outlines with <code className="px-2 py-1 bg-secondary-100 dark:bg-secondary-900">outline: none</code></li>
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Focus rings must have sufficient contrast (3:1 ratio minimum)</li>
                <li className="text-sm font-mono text-secondary-800 dark:text-secondary-500">• Ring offset improves visibility on various backgrounds</li>
